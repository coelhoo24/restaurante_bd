...
-- Tabela de Produtos / Estoque (RF03)
...
-- Tabela de Movimentação de Estoque (RF03, RF05)
...
-- Tabela de Categorias Financeiras (Apoio ao RF04/RF05)
...
-- Tabela de Movimentação Financeira (RF04, RF05)
